  ...
  (function() {
    ...
    describe("The menu", function() {
      ...
      it("is hidden by default", function() {
        ...
        expect(bodyVar.classList.contains("menu-hidden")).toBe(true);
      });
      ...
      it("changes visibility", function() {
        let bodyVar = document.querySelector("body");
        let menuItem = document.querySelector(".menu-icon-link");
        menuItem.click();
        expect(bodyVar.classList.contains("menu-hidden")).toBe(false);
        menuItem.click();
        expect(bodyVar.classList.contains("menu-hidden")).not.toBe(false);
      });
    });
